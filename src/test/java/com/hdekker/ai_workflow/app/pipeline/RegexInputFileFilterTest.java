	...
	public record TestCase(
	    ...
	    public static List<TestCase> testCases() {
	        return List.of(
	            ...
	            new TestCase("Path only capture", "home/user/docs/readme.txt", "(?<path>.*/).*\\.txt", true, "home/user/docs/", ""),

	            // 3. Name Only: No path group in regex
	            new TestCase("Name only capture", "home/user/docs/readme.txt", ".*/(?<name>.*\\.txt)", true, "", "readme.txt"),
	            ...
	            new TestCase("No groups captured", "simple-file.txt", ".*\\.txt", true, "", ""),

	            // 6. Fail Match: Groups should be ""
	            new TestCase("Failed match", "wrong-extension.jpg", ".*\\.txt", false, "", ""),
	            ...
	            new TestCase("Hidden file match", ".gitignore", "(?<name>\\..*)", true, "", ".gitignore"),
