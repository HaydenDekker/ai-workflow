...
/**
 * Builder for configuring the agent processing pipeline.
 * <p>
 * Defines the stages of prompt processing: trigger → enrich → prompt → persist → split.
 * Application-layer orchestrator — no infrastructure dependencies.
 */
